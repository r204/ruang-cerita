                        ...
                        <div class="card-body">
                            <form action="/admin.artikel.edit/<?= $artikel->id; ?>" method="post" enctype="multipart/form-data" autocomplete="off">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-select" aria-label="Default select example" name="category" value="<?= $artikel->category; ?>">
                                        <option selected><?= $artikel->category; ?></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-select" aria-label="Default select example" name="status" value="<?= $artikel->status; ?>">
                                        <option selected><?= $artikel->status; ?></option>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file" class="form-control" id="img1" name="img1" value="<?= $artikel->img1; ?>" onchange="previewImg()">
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="file" class="form-control" id="img2" name="img2" value="<?= $artikel->img2; ?>" onchange="previewImg()">
                                </div>
